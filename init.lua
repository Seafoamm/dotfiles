...
vim.keymap.set('n', '<leader>tt', function()
  -- If we're already in a terminal, just go to normal mode
...
require('lazy').setup({
  ...
  {
    'stevearc/oil.nvim',
    opts = {}, -- optional, you can configure below
    config = function()
      require('oil').setup {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sH', function() require('telescope.builtin').find_files { cwd = vim.loop.os_homedir() } end, { desc = 'Search Home' })
